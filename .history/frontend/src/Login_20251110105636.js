        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Nota de requisitos de contraseña (listado) */}
              <ul style={{ fontSize: 12, color: "#6b7280", marginBottom: 6, paddingLeft: 18, marginTop: 6 }}>
                <li>Al menos 8 caracteres</li>
                <li>Una letra mayúscula</li>
                <li>Una letra minúscula</li>
                <li>Un número</li>
                <li>Un símbolo: <code>! @ # $ _ - .</code></li>
              </ul>
            ...
            {/* Formulario de registro (signup) */}
              ...
              onSubmit={async e => {
                ...
                if (!passRule.test(pass)) {
                  setRegisterError("La contraseña debe tener al menos 8 caracteres, una mayúscula, una minúscula, un número y un símbolo (! @ # $ _ - .)");
                  return;
                }
