        ...
        >
          ...
          >
            ...
            <form
              onSubmit={async e => {
                ...
                try {
                  ...
                  const data = await res.json();
                  if (res.ok) {
                    setRegisterSuccess(data.message || "Registro exitoso");
            ...
            >
              ...
              <div style={{ position: "relative", marginBottom: 4 }}>
                <label style={{ position: "absolute", left: 12, top: registerName ? 7 : "50%", transform: registerName ? "translateY(0)" : "translateY(-50%)", color: "#666666", fontSize: registerName ? 10 : 13, fontWeight: 500, transition: "all 0.2s ease", pointerEvents: "none", background: registerName ? "#ffffff" : "transparent", padding: registerName ? "0 4px" : "0" }}>
                  Nombre
                </label>
                <input type="text" value={registerName} onChange={e => setRegisterName(e.target.value)} style={{ width: "93%", background: "#f8f9fa", color: "#1a1a1a", border: `1px solid #d1d5db`, borderRadius: 8, padding: "10px 12px", fontSize: 13 }} required />
              </div>

              <div style={{ position: "relative", marginBottom: 4 }}>
                <label style={{ position: "absolute", left: 12, top: registerEmail ? 7 : "50%", transform: registerEmail ? "translateY(0)" : "translateY(-50%)", color: "#666666", fontSize: registerEmail ? 10 : 13, fontWeight: 500, transition: "all 0.2s ease", pointerEvents: "none", background: registerEmail ? "#ffffff" : "transparent", padding: registerEmail ? "0 4px" : "0" }}>
                  Email
                </label>
                <input type="email" value={registerEmail} onChange={e => setRegisterEmail(e.target.value)} style={{ width: "93%", background: "#f8f9fa", color: "#1a1a1a", border: `1px solid #d1d5db`, borderRadius: 8, padding: "10px 12px", fontSize: 13 }} required />
              </div>

              <div style={{ position: "relative", marginBottom: 4 }}>
                <label style={{ position: "absolute", left: 12, top: registerPass ? 7 : "50%", transform: registerPass ? "translateY(0)" : "translateY(-50%)", color: "#666666", fontSize: registerPass ? 10 : 13, fontWeight: 500, transition: "all 0.2s ease", pointerEvents: "none", background: registerPass ? "#ffffff" : "transparent", padding: registerPass ? "0 4px" : "0" }}>
                  Contraseña
                </label>
                <input type="password" value={registerPass} onChange={e => setRegisterPass(e.target.value)} style={{ width: "93%", background: "#f8f9fa", color: "#1a1a1a", border: `1px solid #d1d5db`, borderRadius: 8, padding: "10px 12px", fontSize: 13 }} required />
              </div>

              <div style={{ position: "relative", marginBottom: 4 }}>
                <label style={{ position: "absolute", left: 12, top: registerTokenContract ? 7 : "50%", transform: registerTokenContract ? "translateY(0)" : "translateY(-50%)", color: "#666666", fontSize: registerTokenContract ? 10 : 13, fontWeight: 500, transition: "all 0.2s ease", pointerEvents: "none", background: registerTokenContract ? "#ffffff" : "transparent", padding: registerTokenContract ? "0 4px" : "0" }}>
                  ID del Proyecto (Token Contract)
                </label>
                <input type="text" value={registerTokenContract} onChange={e => setRegisterTokenContract(e.target.value)} style={{ width: "93%", background: "#f8f9fa", color: "#1a1a1a", border: `1px solid #d1d5db`, borderRadius: 8, padding: "10px 12px", fontSize: 13 }} required />
              </div>
