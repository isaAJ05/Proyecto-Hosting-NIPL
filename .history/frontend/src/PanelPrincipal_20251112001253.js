                        ...
                        <button
                          ...
                          onClick={async () => {
                            try {
                              ...
                              alert('Error arrancando proyecto: ' + err.message)
                            }
                          }}
                        >
                          ▶️
                        ...
                        <button
                          ...
                          onClick={async () => {
                            try {
                              ...
                              alert('Error deteniendo proyecto: ' + err.message)
                            }
                          }}
                        >
                          ⏸️
                        ...
                        <button
                          ...
                          onClick={async () => {
                            try {
                              ...
                              if (res.ok) refreshProjects()
                              else alert('Error renovando acceso')
                            } catch (err) {
                              console.error('Touch error', err)
                              alert('Error renovando acceso: ' + err.message)
                            }
                          }}
                        >
                          🟢
