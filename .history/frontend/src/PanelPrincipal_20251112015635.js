                    ...
                    microservices.map((microservice) => (
                      <tr key={microservice.id}>
                        ...
                        <button
                          ...
                          title="Abrir"
                          onClick={() => {
                            // Preferir abrir el subdominio; si no existe, abrir el repo origen
                            const tryOpen = (raw) => {
                              if (!raw) return false
                              // Si ya incluye protocolo, respetarlo
                            ...
                            if (!opened && microservice.repo) {
                              const repoOpened = tryOpen(microservice.repo)
                              if (!repoOpened) alert('No se pudo abrir el repositorio')
                            } else if (!opened) {
