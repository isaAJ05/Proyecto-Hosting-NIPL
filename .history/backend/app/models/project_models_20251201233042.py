...
def create_project_from_repo(repo_url, name, user='anon', subdomain=None, cpu=None, memory=None, rate_limit_per_minute=None, owner_email=None, owner_token_contract=None):
    ...
    ok, result = build_and_run(project_id, project_dir, image_tag, subdomain, cpu=cpu, memory=memory, container_name=container_name, rate_limit_per_minute=rate_limit_per_minute)
    if not ok:
        return False, result
