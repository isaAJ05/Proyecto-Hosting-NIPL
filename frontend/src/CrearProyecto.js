...
function CrearProyecto({ onBack, lightTheme }) {
  ...
  const templateInfo = {
    "html-static": {
      ...
      gitUrl: "https://github.com/hosting-templates/html-static-template.git",
      structure: [
...
CMD ["nginx", "-g", "daemon off;"]`,
    ...
    react: {
      ...
      gitUrl: "https://github.com/hosting-templates/react-template.git",
      structure: [
...
CMD ["nginx", "-g", "daemon off;"]`,
    ...
    nodejs: {
      ...
      gitUrl: "https://github.com/hosting-templates/nodejs-express-template.git",
      structure: [
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setProject((prev) => ({
                      ...
                      github_url: selectedTemplate ? templateInfo[selectedTemplate].gitUrl : "",
                    }))
                  }}
                  style={{
                    width: "100%",
